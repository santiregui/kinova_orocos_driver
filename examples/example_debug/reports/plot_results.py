...
fn = 'all_data/reports_from_2020_09_23/report_of_2020_09_23_18_25_11.dat'
print(fn)
...
data_full, header = read_csv_file(fn, 1)
data = data_full[10:-1,:]
...
ax1.plot(data[:,header[0].index('TimeStamp')], data[:,header[0].index('kin.latency')]*1000)
ax1.set_ylabel('Latency [ms]')
ax1.set_title('Latency (max:  ' + str(max(data[:,header[0].index('kin.latency')]*1000)) +  ' ms)')

ax2.plot(data[:,header[0].index('TimeStamp')], data[:,header[0].index('kin.periodicity')]*1000)
ax2.set_ylabel('Periodicity [ms]')
ax2.set_title('Periodicity (max:  ' + str(max(data[:,header[0].index('kin.periodicity')]*1000)) +  ' ms)')
