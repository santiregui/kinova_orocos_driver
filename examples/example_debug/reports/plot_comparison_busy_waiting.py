...
# data, header = read_csv_file('all_data/reports_from_2020_10_02/report_of_2020_10_02_17_48_04.dat', 1)
data, header = read_csv_file('all_data/reports_from_2020_10_02/report_of_2020_10_02_17_58_43.dat', 1)
data2, header2 = read_csv_file('all_data/reports_from_2020_10_02/report_of_2020_10_02_17_58_43.dat', 1)
cut_data = 5
...
ax1.set_title('Periodicity (max:  ' + str(max(data[:,header[0].index('kin.periodicity')])) +  ' ms, min: '+ str(min(data[:,header[0].index('kin.periodicity')]))+  ' ms, mean: '+ str(np.mean(data[:,header[0].index('kin.periodicity')]))  + ' ms)')

# ax2.plot(data2[:,header2[0].index('TimeStamp')],data2[:,header2[0].index('kin.periodicity')])
# ax2.set_ylabel('Periodicity [ms]')
# ax2.set_title('Periodicity with sleep (max:  ' + str(max(data2[:,header2[0].index('kin.periodicity')])) +   ' ms, min: '+ str(min(data2[:,header[0].index('kin.periodicity')]))+   ' ms, mean: '+ str(np.mean(data2[:,header[0].index('kin.periodicity')]))  + ' ms)')
